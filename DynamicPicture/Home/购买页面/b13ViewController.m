...
#import "b13ViewController.h"

@interface b13ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@end
@implementation b13ViewController
    ...
    [MNetworkManager getBuyDataWithUrl:self.dataUrl Success:^(id data)
     {
         ...
         if (_dataArray.count>0)
         {
             ...
             {
                 NSMutableArray *arrs = [[NSMutableArray alloc]initWithArray:@[@"0",@"0",@"0",@"0",@"0",@"0"]];
...
{
    b4Cell *cell = [tableView dequeueReusableCellWithIdentifier:@"cellID"];
    if (!cell)
    {
        cell = [[b4Cell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"cellID"];
    }
...
-(void)buttonClick:(UIButton *)sender
{
    ...
    b4Cell *cell = (b4Cell *)sender.superview.superview.superview;
