...
-(instancetype)initWithTarget:(id)target{
    ...
    if (self) {
        ...
        TBCityIconInfo *info = [TBCityIconInfo iconInfoWithText:KTLFont_Search_iconUnicode size:40 color:[UIColor colorWithHexString:KNavBarHexColor]];
