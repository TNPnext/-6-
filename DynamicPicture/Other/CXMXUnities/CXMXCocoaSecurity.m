...
#pragma mark - CXMXCocoaSecurity
@implementation CXMXCocoaSecurity
...
{
    CXMXCocoaSecurityResult * sha = [self sha384:key];
...
{
    CXMXCocoaSecurityDecoder *decoder = [CXMXCocoaSecurityDecoder new];
...
+ (CXMXCocoaSecurityResult *)aesEncryptWithData:(NSData *)data key:(NSData *)key iv:(NSData *)iv
{
    ...
    if (cryptStatus == kCCSuccess) {
        CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:buffer length:encryptedSize];
        free(buffer);
...
+ (CXMXCocoaSecurityResult *)md5WithData:(NSData *)hashData
{
    ...
    CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:digest length:CC_MD5_DIGEST_LENGTH];
    free(digest);
...
+ (CXMXCocoaSecurityResult *)sha1WithData:(NSData *)hashData
{
    ...
    CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA1_DIGEST_LENGTH];
    free(digest);
...
+ (CXMXCocoaSecurityResult *)sha224WithData:(NSData *)hashData
{
    ...
    CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA224_DIGEST_LENGTH];
    free(digest);
...
+ (CXMXCocoaSecurityResult *)sha256WithData:(NSData *)hashData
{
    ...
    CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA256_DIGEST_LENGTH];
    free(digest);
...
+ (CXMXCocoaSecurityResult *)sha384WithData:(NSData *)hashData
{
    ...
    CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA384_DIGEST_LENGTH];
    free(digest);
...
+ (CXMXCocoaSecurityResult *)sha512WithData:(NSData *)hashData
{
    ...
    CXMXCocoaSecurityResult *result = [[CXMXCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA512_DIGEST_LENGTH];
    free(digest);
...
@implementation CXMXCocoaSecurityResult
...
- (NSString *)hex
{
    CXMXCocoaSecurityEncoder *encoder = [CXMXCocoaSecurityEncoder new];
...
@implementation CXMXCocoaSecurityEncoder
...
@implementation CXMXCocoaSecurityDecoder
...
@implementation NSData (CXMXBase64)
...
@implementation NSString (CXMXBase64)
