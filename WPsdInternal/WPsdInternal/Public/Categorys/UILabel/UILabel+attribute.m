...
- (void)setGapForAttrubtedText:(CGFloat)gap
{
    ...
    [attributedString addAttribute:NSParagraphStyleAttributeName value:paragraphStyle1 range:NSMakeRange(0, (self.attributedText)? self.attributedText.length : self.text.length)];
